...
{
    options.UseSqlServer(@"Server=DESKTOP-TB81M5D\SQLEXPRESS;Database=Medoxity;Trusted_Connection=True;TrustServerCertificate=True;");
});
...
builder.Services.AddRazorPages(); // Додати підтримку Razor Pages
